    ...
    <div class="pb-container-main pb-after-clear">
        ...
        <div class="pb-main pb-navwrap pb-after-clear">
            <div class="pb-iblock pb-fl pb-logo">
                <a href="/show"><img alt="享笑网LOGO 征文比赛 有奖征文" src="images/logo.jpg" /></a>
            </div>
            ...
            <div class="pb-iblock pb-fr pb-oths">
                ...
                <a onclick="Sys.commStat(1);commonLib.addFavorite();" rel="sidebar" href="/show" class="nmt">收藏我们</a>
                <a href="/suggest" class="nmt">投诉建议</a> &nbsp;
                <span class="nmt"> | </span>
        ...
        <div class="pb-main pb-mt20">
            <div class="commmain">
                <div class="one-atl">
                    ...
                    <div class="con f-r">
                        <h3><a class="tle" href="/pic_detail?show/241">爱他们的时候我们像条狗</a><span class="ath"></span></h3>
                        ...
                        <div class="morewp f-l m-t-10">
                            <a class="f-r" href="/pic_detail?show/241">详细</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="one-atl">
                    ...
                    <div class="con f-r">
                        <h3><a class="tle" href="/pic_detail?show/240">爱你的第九年,这是你不必详知的事情</a><span class="ath"></span></h3>
                        ...
                        <div class="morewp f-l m-t-10">
                            <a class="f-r" href="/pic_detail?show/240">详细</a>
                        </div>
                    </div>
                </div>
                <div class="ycjpline"></div>
                <div class="one-atl">
                    ...
                    <div class="con f-r">
                        ...
                        <div class="morewp f-l m-t-10">
                            <a class="f-r" href="/pic_detail?show/170">详细</a>
                        </div>
                    </div>
                </div>
                <div class="ycjpline"></div>
                <div class="one-atl">
                    ...
                    <div class="con f-r">
                        <h3><a class="tle" href="/pic_detail?show/169">爱情只需八分饱</a><span class="ath"></span></h3>
                        ...
                        <div class="morewp f-l m-t-10">
                            <a class="f-r" href="/pic_detail?show/169">详细</a>
                        </div>
                    </div>
                </div>
                <div class="ycjpline"></div>
                <div class="one-atl">
                    ...
                    <div class="con f-r">
                        <h3><a class="tle" href="/pic_detail?show/168">相见不如不见</a><span class="ath"></span></h3>
                        ...
                        <div class="morewp f-l m-t-10">
                            <a class="f-r" href="/pic_detail?show/168">详细</a>
                        </div>
                    </div>
                </div>
                <div class="pb-mt50 pb-listpage">
                    <table>
                        <tbody>
                        <tr>
                            <td><a href="/jiaoxing" class="yiiPagerA on">1</a></td>
            ...
            <div class="commside">
                ...
                <div class="pb-iblock pb-fr pb-after-clear pb-main-side">
                    ...
                    <a href="/news_detail?/add" class="tle pb-mt5">年味为什么越来越淡了</a>
                    <div class="pb-line2 pb-mt5">
                    </div>
                    ...
                    <a href="/news_detail?/add" class="but pb-clr1 pb-size-normal pb-mt15">有奖征文</a>
                </div>
                <!--右侧我要投稿公共部分-->
                <div class="pb-main-side pb-iblock pb-after-clear pb-fr pb-mt40">
                    ...
                    <ul class="pb-mt10 previous-term pb-size-normal">
                        <li> <span>.</span> <a href="/news_detail?-8-55">有一种毕业，叫先走一步</a>
                            <div class="pb-line2">
                            </div> </li>
                        <li> <span>.</span> <a href="/news_detail?-4-27">用今生的修行 为你们的来生祈福</a>
                            <div class="pb-line2">
                            </div> </li>
                        <li> <span>.</span> <a href="/news_detail?-3-16">我的初恋</a>
                            <div class="pb-line2">
                            </div> </li>
                        <li> <span>.</span> <a href="/news_detail?-6-45">当你老了</a>
                            <div class="pb-line2">
                            </div> </li>
                        <li> <span>.</span> <a href="/news_detail?-7-50">我就在这里旅行，给你讲沿途的风景</a>
                            <div class="pb-line2">
                            </div> </li>
                        <li> <span>.</span> <a href="/news_detail?-6-43">有多少爱可以重来</a>
                            <div class="pb-line2">
                            </div> </li>
                        <li> <span>.</span> <a href="/news_detail?-4-28">我的“天空之城”</a>
                            <div class="pb-line2">
                            </div> </li>
                    </ul>
                </div>
                ...
                <div class="sidewrap  pb-mt40">
                    ...
                    <div style="height:480px;overflow:hidden;" class="con pr">
                        <div style="left:150px;height:150px;top:15px;" class="single">
                            <a title="清纯唯美写真合集" href="/pic_detail?1"><img alt="清纯唯美写真合集" src="images/qing_10001_7b053ee001_310.jpg" style="width:145px;" /></a>
                        </div>
                        <div style="left:0px;height:150px;top:15px;" class="single">
                            <a title="也许我就是一块老墨" href="/pic_detail?3"><img alt="也许我就是一块老墨" src="images/qing_10001_2278c48f96_310.jpg" style="width:145px;" /></a>
                        </div>
                        <div style="left:150px;height:150px;top:170px;" class="single">
                            <a title="证件照" href="/pic_detail?4"><img alt="证件照" src="images/qing_9999_6963913fb8_310.jpg" style="width:145px;" /></a>
                        </div>
                        <div style="left:0px;height:150px;top:170px;" class="single">
                            <a title="享笑网2015-5-30#325806#" href="/pic_detail?6"><img alt="享笑网2015-5-30#325806#" src="images/qing_10001_3f5af7636f_310.jpg" style="width:145px;" /></a>
                        </div>
                        <div style="left:150px;height:150px;top:325px;" class="single">
                            <a title="爱情就是一百多年的孤寂" href="/pic_detail?7"><img alt="爱情就是一百多年的孤寂" src="images/qing_10001_5502d62ca8_310.jpg" style="width:145px;" /></a>
                        </div>
                        <div style="left:0px;height:150px;top:325px;" class="single">
                            <a title="中国书法家【郝天明】书法新作(妙笔生辉" href="/pic_detail?10"><img alt="中国书法家【郝天明】书法新作(妙笔生辉" src="images/qing_10001_bcf83a76ac_310.jpg" style="width:145px;" /></a>
                        </div>
                    </div>
                </div>
            </div>
