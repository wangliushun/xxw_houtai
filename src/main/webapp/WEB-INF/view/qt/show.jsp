...
<div class="pb-container">
    <div class="pb-container-main pb-after-clear">
        ...
        <div class="pb-main pb-navwrap pb-after-clear">
            ...
            <div class="pb-iblock pb-fr pb-oths">
              ...
              commonLib.SetHome(this);">设为首页</a>
                <a class="nmt" href="/show" rel="sidebar" onclick="Sys.commStat(1);
              commonLib.addFavorite();">收藏我们</a>
                ...
                <div class="pb-ucenter pb-after-clear">
                    ...
                    <br />
                    <ul>
                        <li><a href="/suggest" id="uSetEntry"><i class="pb-icons my"></i> 个人中心</a></li>
        ...
        <div class="pb-main pb-mt20">
            <h3 class="idx-t1"> <a href="/zhengwen" class="pb-clr1">征文比赛</a> </h3>
            <div class="idx-line1">
            </div>
            ...
            <div style="clear:both;"></div>
            <h3 class="idx-t1 pb-mt50"> <a href="/meiri" class="pb-clr1">每日一笑</a> </h3>
            <div class="idx-line1">
            </div>
            <div class="idx-mryx pb-mt20 pb-after-clear">
                <div class="d1 pb-fl">
                    <img src="images/b_smile_left.jpg" class="pb-fl" alt="最新搞笑段子,每日一笑" />
                    <a href="/meiri" class="tle pb-fl pb-clr1">搞笑段子&nbsp;&nbsp;|&nbsp;&nbsp; <span class="pb-clr2">更多</span></a>
                ...
                <div class="d1 pb-fl d1-2">
                    ...
                    <a href="/meiri" class="tle pb-fl pb-clr1">笑话排行&nbsp;&nbsp;|&nbsp;&nbsp; <span class="pb-clr2">更多</span></a>
                    <ul class="pb-mt15 pb-fl pb-size-normal">
